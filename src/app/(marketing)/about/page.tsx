...
export const metadata: Metadata = {
  ...
  description:
    "Meet Saddlewood Contracting: a Scottsdale remodeler with 4 ROC licenses (General, HVAC, Electrical, Plumbing) and in-house crews. No subcontractor coordination.",
  alternates: {
    canonical: "/about",
  },
  openGraph: {
